...
//   });
//
//   // HÀM SEEDING DỮ LIỆU CHUẨN
//   Future<void> _seedStudentsToFirebase(BuildContext context) async {
//     try {
//       // 1. Báo hiệu đang chạy
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('⏳ Đang đồng bộ dữ liệu lên Firebase...')),
//       );
//
//       // 2. Trỏ đúng vào địa chỉ lớp học của bạn trên Firebase
//       final db = FirebaseFirestore.instance;
//       final studentsRef = db
//           .collection('class')
//           .doc('aitCdrfy9681n3QXdg6p') // ID chuẩn từ ảnh của bạn
//           .collection('students');
//
//       // 3. Vòng lặp đẩy 42 học sinh lên
//       for (var student in homeroomRoster) {
//         // Đặt key theo chuẩn snake_case của database
//         await studentsRef.doc(student.id).set({
//           'student_id': student.id,
//           'full_name': student.name,
//           'short_name': student.short,
//           'dob': '15/05/2008',
//           'parent_phone': '0901234567',
//         });
//       }
//
//       // 4. Báo hiệu thành công
//       if (context.mounted) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
//             content: Text('✅ Đã tạo xong 42 học sinh mẫu!'),
//             backgroundColor: Colors.green,
//           ),
//         );
//       }
//     } catch (e) {
//       debugPrint('Lỗi Seeding: $e');
//     }
//   }
//
//   @override
...
//       body: Column(
//         children: [
//           // Phần Header (Truyền context vào để dùng cho nút chuông)
...
//           Row(
//             children: [
//               // Nút chuông thông báo (Đã gắn tính năng Seeding)
//               InkWell(
//                 onTap: () {
//                   // GỌI HÀM KHI BẤM CHUÔNG
//                   _seedStudentsToFirebase(context);
//                 },
